...
fetch(
    ...
    { method: 'POST',
      headers: {
        ...
        'Client-ID': 'rf5rz2l7mhh48x5q4dyqyuiikr3dyg', // claves oscar
        'Authorization': 'Bearer 1hkmbgavqo7ztv6wvc71gts84u4z1q',
      },
      body: `fields id, name; where id = (${num},${num+1},${num+2},${num+3},${num+4},${num+5},${num+6},${num+7},${num+8},${num+9}); sort id asc;`
  })
  .then(response => {
    if (!response.ok) {
        ...
        for(let i = 0; i < 10; i++){
            ...
            if(data[i] == undefined){
                ...
                await pool.request()
                  ...
                  .query(querys.addlanguagesupporttype);
