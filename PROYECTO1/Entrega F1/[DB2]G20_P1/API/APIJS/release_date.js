...
const peticion = () => {
    fetch(
            ...
            body: `fields id, date, human, platform, region, status, m, y, id_game; where id = (${num},${num+1},${num+2},${num+3},${num+4},${num+5},${num+6},${num+7},${num+8},${num+9}); sort id asc;`
                ...
                for(let i = 0; i < 10; i++){
                    ...
                    if(data[i] == undefined){
                        ...
                        await pool.request()
                          ...
                          .input("id_game", sql.Int, data[i].id_game)
