...
fetch(
        ...
        body: `fields id, identifier, name; where id = (${num},${num+1},${num+2},${num+3},${num+4},${num+5},${num+6},${num+7},${num+8},${num+9}); sort id asc;`
            ...
            for(let i = 0; i < 10; i++){
                ...
                if(data[i] == undefined){
                    ...
                    await pool.request()
                      ...
                      .input("identifier", sql.VarChar, data[i].identifier )
                      .input("name", sql.VarChar, data[i].name)
                      .query(querys.addRegion);
